...
import { DF_CHALLENGE_EASY, DF_CHALLENGE_HARD, DF_CHALLENGE_MEDIUM } from "@/consts/difficulty";

export const Devious : Challenge = {
	name: 'Devious',
	difficulty: DF_CHALLENGE_MEDIUM,
...
export const ColdRevenge : Challenge = {
	name: "Cold Revenge",
	difficulty: DF_CHALLENGE_MEDIUM + 1,
